...
namespace SDK {
    ...
    ue::C_WeakPtr<ue::sys::core::C_SceneObject> C_HumanSpawner::SetupDefaultArchetypeObject() {
        return (*(ue::C_WeakPtr<ue::sys::core::C_SceneObject>(__thiscall *)(ue::game::traffic::C_HumanSpawner *))gPatterns.C_HumanSpawner__SetupDefaultArchetypeObjectAddr)(this);
    }
} // namespace SDK